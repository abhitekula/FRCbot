...
//            dist = frontSonar.getRangeInches();
            ...
            AxisCamera gearCamera = CameraServer.getInstance().addAxisCamera("Camera", RobotMap.CAMERA_IP);
            gearCamera.setResolution(320, 240);

            gearSink = CameraServer.getInstance().getVideo("Camera");

            gearOutputStream = CameraServer.getInstance().putVideo("Processed", 320, 240);
